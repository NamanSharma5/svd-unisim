...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        # do_classifier_free_guidance = max_guidance_scale > 1.0 # this should be equivalent to self.do_classifier_free_guidance
        ...
        # 6. Prepare timesteps - NOTE: potential hotspot
