...
data_sub_folder = True
custom_target_folder = True
target_folder = '/vol/biomedic3/bglocker/ugproj2324/nns20/svd-unisim/data_pipeline/data'
...
class EpicDownloader:
    def __init__(self,
                 ...
                 base_output= str(Path.home()) if not custom_target_folder  else target_folder,
                 splits_path_epic_55='data/epic_55_splits.csv' if data_sub_folder else 'epic_55_splits.csv',
                 splits_path_epic_100='data/epic_100_splits.csv' if data_sub_folder else 'epic_100_splits.csv',
                 md5_path='data/md5.csv' if data_sub_folder else 'md5.csv',
                 errata_path='data/errata.csv' if data_sub_folder else 'errata.csv',
                 errata_only=False):
...
def create_parser():
    ...
    parser.add_argument('--output_path', nargs='?', type=str, default=target_folder)
